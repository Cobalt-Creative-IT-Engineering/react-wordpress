...
export default function ArtistModal({ item, jourMap, lieuMap, mediaMap, onClose }: ArtistModalProps) {
  ...
  // URL billetterie directe (champ artiste), sinon route générale
  const billetterieUrl = (item.acf?.lien_vers_la_billetterie as string | undefined) || "#/billetterie";
      ...
      >
        ...
        <div className="artist-modal-inner">
          ...
          <div className="artist-modal-body">
            ...
            <a href={billetterieUrl} className="artist-modal-cta">
              Billetterie
            </a>
